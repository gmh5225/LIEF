...
public:
    ...
    verify_signature(Signature::VERIFICATION_CHECKS checks = Signature::VERIFICATION_CHECKS::DEFAULT) const;
    ...
    Section *add_section(
        ...
        SECTION_CHARACTERISTICS characteristic = SECTION_CHARACTERISTICS::IMAGE_SCN_CNT_CODE |
